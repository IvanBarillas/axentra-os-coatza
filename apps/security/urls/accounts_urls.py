...
from apps.security.views.accounts_views import (
    accounts_dashboard_view, funcionario_cambiar_password_view, funcionario_create_view, funcionario_editar_view, funcionario_list_view, funcionario_soft_delete_view, funcionario_toggle_status_view,
