"""Rutas HTTP de la aplicación Inventory."""
...
urlpatterns = [
    # Panel principal. El menú global puede enlazar directamente a asset_list.
    ...
    path(
        "assets/<uuid:asset_id>/correct/",
        asset_correct_view,
        name="asset_correct",
    ),
    path(
        "assets/<uuid:asset_id>/condition/",
        asset_condition_view,
    ...
    path(
        "intakes/<uuid:intake_id>/submit/",
        intake_submit_view,
        name="intake_submit",
    ),
    path(
        "intakes/<uuid:intake_id>/department-decision/",
        intake_department_decision_view,
        name="intake_department_decision",
    ),
    path(
        "intakes/<uuid:intake_id>/send-to-patrimony/",
        intake_send_to_patrimony_view,
        name="intake_send_to_patrimony",
    ),
    path(
        "intakes/<uuid:intake_id>/observe/",
        intake_observe_view,
        name="intake_observe",
    ),
    path(
        "intakes/<uuid:intake_id>/approve/",
        intake_approve_view,
        name="intake_approve",
    ),
    path(
        "intakes/<uuid:intake_id>/register/",
        intake_register_view,
        name="intake_register",
    ),
    path(
        "intakes/<uuid:intake_id>/cancel/",
        intake_cancel_view,
        name="intake_cancel",
    ),
    ...
    path(
        "physical-audits/",
        physical_audit_list_view,
        name="physical_audit_list",
    ),
    path(
        "physical-audits/<uuid:session_id>/",
        physical_audit_detail_view,
        name="physical_audit_detail",
    ),
