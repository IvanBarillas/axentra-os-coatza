...
from apps.inventory.views import (
    ...
    custody_release_individual_view,
...
urlpatterns = [
    ...
    path("custodies/documents/<uuid:document_id>/release/", custody_document_release_view, name="custody_document_release"),
    path("custodies/<uuid:custody_id>/prepare-release/", custody_release_individual_view, name="custody_release_individual"),
