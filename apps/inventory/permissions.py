...
Las llaves deben permanecer estables porque se almacenan como snapshot en
UserAppRole.permissions_list.
"""
...
class InventoryPermissions:
    ...
    PERMISSIONS = {
        ...
        "can_view_assets": (
            "Permite consultar bienes patrimoniales."
        ),
        ...
        "can_submit_asset_intake": (
            "Permite enviar solicitudes de alta a revisión."
        ),
        "can_approve_department_intake": (
            "Permite aceptar o rechazar altas por la dependencia."
        ),
        "can_validate_patrimony_intake": (
            "Permite validar altas y crear el activo patrimonial oficial."
        ),

        # Expediente patrimonial
        "can_edit_asset": (
            "Permite corregir datos administrativos autorizados del activo."
        ),
        "can_correct_asset": (
        ...
        "can_view_financials": (
            "Permite consultar depreciación, valor en libros e información contable."
        ),
    ...
    # Mantener solamente rutas que ya existen. Las nuevas se agregarán junto
    # con sus views/URLs para evitar NoReverseMatch en los templates.
    SIDEBAR_MENU = [
        [
            "layout-dashboard",
            "Panel de Inventario",
    ...
    CAPABILITIES = {
        "can_operate": {
            ...
            "help_text": (
                "Permite que la dependencia capture solicitudes, "
                "resguardos y operaciones ordinarias de Inventory."
            ),
        },
        "can_supervise": {
        ...
        "can_authorize": {
            ...
            "help_text": (
                "Habilita a la dependencia para participar en decisiones "
                "que además exigen un permiso individual de autorización."
            ),
        },
    }
